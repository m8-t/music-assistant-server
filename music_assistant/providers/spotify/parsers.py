...
def parse_podcast_episode(
    ...
    # Get or create a podcast reference if not provided.
    # The (simplified) show object embedded in an episode carries the show's
    # description, artwork and publisher, so parse it in full instead of
    # building a name-only stub.
