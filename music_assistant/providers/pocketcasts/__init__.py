...
from music_assistant.helpers.podcast_parsers import get_episode_transcript
...
class PocketCastsProvider(MusicProvider):
    ...
    async def get_podcast_episodes(self, prov_podcast_id: str) -> AsyncGenerator[PodcastEpisode]:
        ...
        :param prov_podcast_id: The provider podcast id.
        """
        # fetch episode metadata, user status and transcript availability in parallel
        episodes, in_progress, history, transcripts = await asyncio.gather(
